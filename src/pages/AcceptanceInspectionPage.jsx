...
export default function AcceptanceInspectionPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-50">
      {/* Header */}
      <div className="bg-emerald-600 text-white p-6 sticky top-0 z-10">
    ...
    <div className="space-y-3 pb-20">
      {dummyData.map((item) => (
        <button
          ...
          className="w-full bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-md transition-all p-4 text-left"
        >
...
function FormTab() {
  ...
  return (
    <form
      ...
      className="bg-white rounded-xl shadow-md p-6 space-y-5 relative pb-24"
    >
      {/* Customer Selection */}
      <div className="relative">
        ...
        <div
          onClick={() =>
            setActiveSelect(activeSelect === "customer" ? null : "customer")
          }
      ...
      <div className="relative">
        ...
        >
          <span
            className={
              formData.name ? "text-gray-800 font-medium" : "text-gray-400"
            }
          >
            {formData.name
              ? `${formData.nameCode} - ${formData.name}`
              : "Select Name"}
          </span>
          <span className="text-gray-400">▼</span>
        </div>
          ...
          <div className="bg-white border border-emerald-200 rounded-xl p-3 shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="font-mono text-xs text-gray-700 break-all bg-gray-50 p-2 rounded border border-gray-100 mt-1">
                  {formData.qrData}
                </p>
              </div>
              <button
      ...
      <div className="relative">
        ...
        <div
          onClick={() =>
            setActiveSelect(activeSelect === "part" ? null : "part")
          }
          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl flex items-center justify-between cursor-pointer hover:border-emerald-500 transition-colors"
        >
          <span
            className={
              formData.partName ? "text-gray-800 font-medium" : "text-gray-400"
            }
          >
            {formData.partName
              ? `${formData.partCode} - ${formData.partName}`
              : "Select Part"}
          </span>
          <span className="text-gray-400">▼</span>
        </div>
      ...
      <button
        type="submit"
        className="w-full bg-emerald-600 text-white py-3.5 rounded-xl font-medium hover:bg-emerald-500 transition-all duration-200 mt-4"
      >
        Submit Stock In
      </button>
        ...
        <div className="p-6 space-y-4">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Point your scanner or type manually.
              <br />
              Press{" "}
